 ...
 */
public class Spark04_RDD_apache_log implements Serializable {
    public static void main(String[] args) {
        ...
        /*3.1 指定读取目录下的文件*/
        JavaRDD<String> lineRDD = javaSparkContext.textFile("D:\\proc_idea\\study\\ruge-study-senior\\spark-core\\file\\apache.log");


        /*分词切割*/
        JavaRDD<String> wordsRDD = lineRDD.flatMap((FlatMapFunction) o -> {
            String line = (String) o;
            return Arrays.asList(line.split("\\s+")[6]).iterator();
        });
