...
//import com.ruge.es5.tool.ElasticsearchTool;
//import com.ruge.es5.tool.EsPage;
...
//        if (!ElasticsearchTool.isIndexExist(indexName)) {
//            ElasticsearchTool.createIndex(indexName);
//        } else {
//            return "索引已经存在";
//        }
//        return "索引创建成功";
...
//        String id = ElasticsearchTool.addData(jsonObject, indexName, esType, jsonObject.getString("id"));
//        return id;
//    }
//
//    /**
...
//            ElasticsearchTool.deleteDataById(indexName, esType, id);
//            return "删除id=" + id;
//        } else {
//            return "id为空";
//        }
...
//            jsonObject.put("date", new Date());
//            ElasticsearchTool.updateDataById(jsonObject, indexName, esType, id);
//            return "id=" + id;
//        } else {
//            return "id为空";
//        }
...
//        if (StringUtils.isNotBlank(id)) {
//            Map<String, Object> map = ElasticsearchTool.searchDataById(indexName, esType, id, null);
...
//        }
//        List<Map<String, Object>> list = ElasticsearchTool.searchListData(indexName, esType, boolQuery, 10, null, null, null);
...
//        List<Map<String, Object>> list = ElasticsearchTool.searchListData(indexName, esType, queryBuilder, 10, null, null, null);
//        return JSONObject.toJSONString(list);
//    }
//
//    /**
...
//            EsPage list = ElasticsearchTool.searchDataPage(indexName, esType, Integer.parseInt(startPage), Integer.parseInt(pageSize), boolQuery, null, null, null);
//            return JSONObject.toJSONString(list);
//        } else {
